...
func (_c *MenuCreate) SetCreatedBy(v int64) *MenuCreate {
	_c.mutation.SetCreatedBy(v)
	return _c
}

// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (_c *MenuCreate) SetNillableCreatedBy(v *int64) *MenuCreate {
	if v != nil {
		_c.SetCreatedBy(*v)
	}
	return _c
...
func (_c *MenuCreate) SetUpdatedBy(v int64) *MenuCreate {
	_c.mutation.SetUpdatedBy(v)
	return _c
}

// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (_c *MenuCreate) SetNillableUpdatedBy(v *int64) *MenuCreate {
	if v != nil {
		_c.SetUpdatedBy(*v)
	}
	return _c
...
func (_c *MenuCreate) SetTenantID(v int64) *MenuCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *MenuCreate) SetNillableTenantID(v *int64) *MenuCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *MenuCreate) SetVersion(v int) *MenuCreate {
	_c.mutation.SetVersion(v)
	return _c
}

// SetNillableVersion sets the "version" field if the given value is not nil.
func (_c *MenuCreate) SetNillableVersion(v *int) *MenuCreate {
	if v != nil {
		_c.SetVersion(*v)
	}
	return _c
...
func (_c *MenuCreate) SetLocation(v string) *MenuCreate {
	_c.mutation.SetLocation(v)
	return _c
}

// SetNillableLocation sets the "location" field if the given value is not nil.
func (_c *MenuCreate) SetNillableLocation(v *string) *MenuCreate {
	if v != nil {
		_c.SetLocation(*v)
	}
	return _c
...
func (_c *MenuCreate) AddItemIDs(ids ...int) *MenuCreate {
	_c.mutation.AddItemIDs(ids...)
	return _c
}

// AddItems adds the "items" edges to the MenuItem entity.
func (_c *MenuCreate) AddItems(v ...*MenuItem) *MenuCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *MenuCreate) check() error {
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`ent: missing required field "Menu.version"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
	...
	if _, ok := _c.mutation.Slug(); !ok {
		return &ValidationError{Name: "slug", err: errors.New(`ent: missing required field "Menu.slug"`)}
	}
	if _, ok := _c.mutation.Location(); !ok {
		return &ValidationError{Name: "location", err: errors.New(`ent: missing required field "Menu.location"`)}
	}
	return nil
}
