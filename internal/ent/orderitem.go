...
func (*OrderItem) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case orderitem.FieldMetadata:
			values[i] = new([]byte)
		case orderitem.FieldID, orderitem.FieldCreatedBy, orderitem.FieldUpdatedBy, orderitem.FieldTenantID, orderitem.FieldVersion, orderitem.FieldOrderID, orderitem.FieldVariantID, orderitem.FieldQuantity, orderitem.FieldUnitAmount, orderitem.FieldTotalAmount:
			values[i] = new(sql.NullInt64)
		case orderitem.FieldSku, orderitem.FieldTitle:
...
func (_m *OrderItem) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case orderitem.FieldUnitAmount:
			if value, ok := values[i].(*sql.NullInt64); !ok {
