...
func (_q *BlogPostQuery) QueryTranslations() *BlogPostTranslationQuery {
	query := (&BlogPostTranslationClient{config: _q.config}).Query()
...
func (_q *BlogPostQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *BlogPostQuery) FirstIDX(ctx context.Context) int {
...
func (_q *BlogPostQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *BlogPostQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *BlogPostQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *BlogPostQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *BlogPostQuery) WithTranslations(opts ...func(*BlogPostTranslationQuery)) *BlogPostQuery {
	query := (&BlogPostTranslationClient{config: _q.config}).Query()
...
//		GroupBy(blogpost.FieldCreatedBy).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.BlogPost.Query().
//		Select(blogpost.FieldCreatedBy).
//		Scan(ctx, &v)
...
func (_q *BlogPostQuery) loadTranslations(ctx context.Context, query *BlogPostTranslationQuery, nodes []*BlogPost, init func(*BlogPost), assign func(*BlogPost, *BlogPostTranslation)) error {
