...
func (_c *TagCreate) SetTenantID(v int64) *TagCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *TagCreate) SetNillableTenantID(v *int64) *TagCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *TagCreate) SetVersion(v int) *TagCreate {
	_c.mutation.SetVersion(v)
	return _c
}

// SetNillableVersion sets the "version" field if the given value is not nil.
func (_c *TagCreate) SetNillableVersion(v *int) *TagCreate {
	if v != nil {
		_c.SetVersion(*v)
	}
	return _c
...
func (_c *TagCreate) AddTranslationIDs(ids ...int) *TagCreate {
	_c.mutation.AddTranslationIDs(ids...)
	return _c
}

// AddTranslations adds the "translations" edges to the TagTranslation entity.
func (_c *TagCreate) AddTranslations(v ...*TagTranslation) *TagCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TagCreate) AddProductIDs(ids ...int) *TagCreate {
	_c.mutation.AddProductIDs(ids...)
	return _c
}

// AddProducts adds the "products" edges to the Product entity.
func (_c *TagCreate) AddProducts(v ...*Product) *TagCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
