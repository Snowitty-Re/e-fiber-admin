...
func HasTranslations() predicate.Category {
...
func HasTranslationsWith(preds ...predicate.CategoryTranslation) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
