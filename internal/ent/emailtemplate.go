...
type EmailTemplateEdges struct {
	...
	Translations []*EmailTemplateTranslation `json:"translations,omitempty"`
...
func (e EmailTemplateEdges) TranslationsOrErr() ([]*EmailTemplateTranslation, error) {
	if e.loadedTypes[0] {
...
func (*EmailTemplate) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case emailtemplate.FieldVariables:
			values[i] = new([]byte)
		case emailtemplate.FieldID, emailtemplate.FieldCreatedBy, emailtemplate.FieldUpdatedBy, emailtemplate.FieldTenantID, emailtemplate.FieldVersion:
			values[i] = new(sql.NullInt64)
		case emailtemplate.FieldCode:
...
// QueryTranslations queries the "translations" edge of the EmailTemplate entity.
func (_m *EmailTemplate) QueryTranslations() *EmailTemplateTranslationQuery {
	return NewEmailTemplateClient(_m.config).QueryTranslations(_m)
}
