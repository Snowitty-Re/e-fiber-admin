...
const (
	// Label holds the string label denoting the mediatranslation type in the database.
	Label = "media_translation"
	...
	EdgeMedia = "media"
	// Table holds the table name of the mediatranslation in the database.
	Table = "media_translations"
	// MediaTable is the table that holds the media relation/edge.
	MediaTable = "media_translations"
...
// Columns holds all SQL columns for mediatranslation fields.
var Columns = []string{
	FieldID,
	FieldCreatedBy,
	FieldUpdatedBy,
...
var (
	...
	// DefaultAlt holds the default value on creation for the "alt" field.
	DefaultAlt string
)

// OrderOption defines the ordering options for the MediaTranslation queries.
