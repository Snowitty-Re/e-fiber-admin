...
func (_q *InquiryQuery) QueryForm() *FormDefinitionQuery {
...
func (_q *InquiryQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *InquiryQuery) FirstIDX(ctx context.Context) int {
...
func (_q *InquiryQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *InquiryQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *InquiryQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *InquiryQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InquiryQuery) WithForm(opts ...func(*FormDefinitionQuery)) *InquiryQuery {
	query := (&FormDefinitionClient{config: _q.config}).Query()
...
//		GroupBy(inquiry.FieldCreatedBy).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *InquiryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Inquiry, error) {
	...
	if query := _q.withForm; query != nil {
		if err := _q.loadForm(ctx, query, nodes, nil,
			func(n *Inquiry, e *FormDefinition) { n.Edges.Form = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *InquiryQuery) loadForm(ctx context.Context, query *FormDefinitionQuery, nodes []*Inquiry, init func(*Inquiry), assign func(*Inquiry, *FormDefinition)) error {
...
func (_q *InquiryQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withForm != nil {
			_spec.Node.AddColumnOnce(inquiry.FieldFormID)
		}
	}
