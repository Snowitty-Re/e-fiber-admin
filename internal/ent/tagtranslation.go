...
func (*TagTranslation) scanValues(columns []string) ([]any, error) {
	values := make([]any, len(columns))
	for i := range columns {
		switch columns[i] {
		case tagtranslation.FieldID, tagtranslation.FieldCreatedBy, tagtranslation.FieldUpdatedBy, tagtranslation.FieldTenantID, tagtranslation.FieldVersion, tagtranslation.FieldTagID:
			values[i] = new(sql.NullInt64)
		case tagtranslation.FieldLocale, tagtranslation.FieldName:
...
func (_m *TagTranslation) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the TagTranslation.
// This includes values selected through modifiers, order, etc.
func (_m *TagTranslation) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryTag queries the "tag" edge of the TagTranslation entity.
func (_m *TagTranslation) QueryTag() *TagQuery {
	return NewTagTranslationClient(_m.config).QueryTag(_m)
}
...
func (_m *TagTranslation) Update() *TagTranslationUpdateOne {
	return NewTagTranslationClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the TagTranslation entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *TagTranslation) Unwrap() *TagTranslation {
...
func (_m *TagTranslation) String() string {
