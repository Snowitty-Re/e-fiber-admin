...
func (_q *RoleQuery) QueryAdmins() *AdminUserQuery {
...
func (_q *RoleQuery) WithAdmins(opts ...func(*AdminUserQuery)) *RoleQuery {
	query := (&AdminUserClient{config: _q.config}).Query()
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withAdmins; query != nil {
		if err := _q.loadAdmins(ctx, query, nodes,
			func(n *Role) { n.Edges.Admins = []*AdminUser{} },
			func(n *Role, e *AdminUser) { n.Edges.Admins = append(n.Edges.Admins, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadAdmins(ctx context.Context, query *AdminUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *AdminUser)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(adminuser.FieldID), joinT.C(role.AdminsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(role.AdminsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.AdminsPrimaryKey[0]))
