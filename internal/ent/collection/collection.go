...
const (
	...
	TranslationsTable = "collection_translations"
	// TranslationsInverseTable is the table name for the CollectionTranslation entity.
	// It exists in this package in order to avoid circular dependency with the "collectiontranslation" package.
	TranslationsInverseTable = "collection_translations"
	// TranslationsColumn is the table column denoting the translations relation/edge.
	TranslationsColumn = "collection_id"
	...
	ProductsColumn = "collection_products"
)
...
func StatusValidator(s Status) error {
	...
	case StatusDraft, StatusPublished, StatusArchived:
		return nil
	default:
		return fmt.Errorf("collection: invalid enum value for status field: %q", s)
	}
}
